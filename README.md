...
3. Download the latest release from the releases tab [here](https://github.com/Omega172/Blush-Blush-Cheat/releases/latest/download/OmegaWare_BlushBlush.dll) and place the `OmegaWare_CrushCrush.dll` file in `BepInEx/plugins`<br/>
